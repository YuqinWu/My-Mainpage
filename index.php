    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <p><i class="fa fa-file-pdf-o fa-fw w3-margin-right w3-large w3-text-teal"></i><a href="https://drive.google.com/drive/folders/0B9DT2aLlCBU4VFJMM1N2SGktbEE" target="_blank">Resume(AI)</a></p>
          <p><i class="fa fa-file-pdf-o fa-fw w3-margin-right w3-large w3-text-teal"></i><a href="https://drive.google.com/drive/folders/0B9DT2aLlCBU4VFJMM1N2SGktbEE" target="_blank">Resume(SDE)</a></p>
